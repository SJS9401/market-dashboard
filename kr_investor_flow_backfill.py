...
def fetch_page(token, appkey, appsecret, date_yyyymmdd):
    """기준일로부터 과거 300 거래일 조회. rows (최신순) 반환."""
    params = (f"FID_COND_MRKT_DIV_CODE=U&FID_INPUT_ISCD=0001"
              f"&FID_INPUT_DATE_1={date_yyyymmdd}&FID_INPUT_ISCD_1=KSP"
              f"&FID_INPUT_DATE_2={date_yyyymmdd}&FID_INPUT_ISCD_2=0001")
