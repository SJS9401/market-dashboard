...
![ABB 12년 매출 & OPM 추이](charts/ABB_chart1_revenue_OPM_12y.png)
...
![ABB 12년 손익 4지표](charts/ABB_chart1b_손익4지표_12y.png)

![ABB 12년 손익·자본 추이](charts/ABB_chart12_income_capital_12y.png)

(3) 주가 역사 (20년)

![ABB 시가총액 추이 (Yahoo Finance ABBNY)](charts/ABB_chart11_market_cap_20y.png)
...
![ABB Product Matrix](charts/ABB_chart3_product_matrix.png)

(2) 분기 사업부별 매출 (Q1 25 ~ Q1 26)

![ABB 분기 사업부별 매출](charts/ABB_chart2_segment_quarterly.png)

![ABB 분기 매출 & Op EBITA Margin (Q3 18-Q1 26, 31Q)](charts/ABB_chart10_quarterly_31Q.png)
...
![ABB Balance Sheet Evolution](charts/ABB_chart4_balance_sheet_6y.png)
...
![ABB Cash Flow](charts/ABB_chart6_cashflow_6y.png)
...
![ABB CapEx Trend](charts/ABB_chart8_capex_12y.png)
...
![ABB Shareholder Returns](charts/ABB_chart9_shareholder_returns_12y.png)
...
![ABB Shareholder Structure](charts/ABB_chart5_shareholders.png)
...
![ABB R&D Investment Trend](charts/ABB_chart7_RD_12y.png)
...
- **v1.5 (2026-05-25)** — 핸드오프 표준 5가지 retrofit. 12년 손익 표 narrative annotation 추가 (CEO 교체·Power Grids 매각·코로나·secular 진입·Robotics 분사 변곡점 marker), 밸류에이션에 삼성전자 비교 1줄 추가 ("PER 단독 secular pure-play, downcycle 부재"), 재평가 트리거를 실적 추적 변수에서 '분류 변경 조건' 3종으로 재정의 (Electrification 사이클 강등 / Process Auto 비중 증가 사이클 / Robotics 분사 완료 Pure secular 격상)
...
- **v1.3 (2026-05-19, 누락 IR 추가 fetch)**: **사용자 지적 "누락된 IR 자료 한번만 더 찾아봐" 반영 — 6건 추가 다운로드**
  ...
  - **여전히 남은 8 분기 gap (정직)**:
    ...
    - **보강 방법**: Form 20-F 2022 (NYSE 자진 상장폐지 직전 마지막 SEC filing) 다운로드 가능하면 FY21-FY22 4분기 정확값 보완 가능 — 그러나 ABB는 FY21 이후 SEC 20-F 작성 중단 (자진 상장폐지로 인