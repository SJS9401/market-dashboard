...
![SanDisk 12년 Revenue & OPM·NPM (old SanDisk → WD Flash → Standalone)](charts/SNDK_chart1_매출OPM_12년.png)

→ (출처: Sandisk Corp FY25 10-K + WD historical Flash segment 추정)

![SanDisk 12년 손익 4지표](charts/SNDK_chart1b_손익4지표_12년.png)

![SanDisk 12년 Revenue·OP·Equity + Equity YoY](charts/SNDK_chart12_손익자본추이_12년.png)

(3) 주가 역사 (분사 후 15개월 — NAND 슈퍼사이클로 30배+ 폭등)

![SanDisk 시가총액 추이 — NAND 슈퍼사이클로 30배+ 폭등](charts/SNDK_chart11_시가총액_분사후.png)
...
![SanDisk 사업부별 매출 (3 end-markets, FY23~FY25) — Cloud +195%](charts/SNDK_chart2_사업부별_3년.png)
...
![SanDisk 직전 12분기 Revenue & OPM 추정 (Q3 23~Q2 26)](charts/SNDK_chart10_12분기시계열.png)
...
![SanDisk 12년 자산·자본·부채](charts/SNDK_chart4_자산자본부채_12년.png)
...
![SanDisk 12년 Cash Flow (CapEx는 direct만, Flash Ventures JV 50% 별도)](charts/SNDK_chart6_현금흐름_12년.png)
...
![SanDisk 12년 R&D Investment](charts/SNDK_chart7_R&D투자_12년.png)
...
![SanDisk 12년 Direct CapEx](charts/SNDK_chart8_CapEx_12년.png)
...
![SanDisk 주주환원 — 분사 후 신규 상장 직후, 정책 미발표](charts/SNDK_chart9_주주환원_12년.png)
...
![SanDisk 주주 구성 (2025말 13F 추정)](charts/SNDK_chart5_주주지분.png)
