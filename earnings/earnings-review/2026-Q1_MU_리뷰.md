...
→ **역대급 트리플 비트 + 6주 후 시장이 secular로 인정** — 매출 $23.86B (가이던스 +27%, 컨센 +19%), Non-GAAP EPS $12.20 (+45%), GPM 74.9% (+7pp). 발표 직후 -4% sell-the-news → 3/30 -30% 폭락 (TurboQuant 충격) → 4월 한 달 +53% 회복 → **5/2 ATH $542.21**.
...
→ 일회성 vs 구조적 결정적 시점
→ 81% 달성 → 멀티플 영구 재평가 narrative 강화
→ 78% 미달 → cyclical peak 우려
...
(2) 시장 반응 해석
→ 발표 직후 -4% → 3/30 -30% 폭락 (TurboQuant + CapEx 우려) → 4월 +53% 회복 → ATH $542
→ 6주 만에 평균 PT +94% 상향
→ "Narrative shock"보다 fundamentals가 결국 이김
→ 시장이 cyclical → secular 인식 전환
