...
![마이크론 FY26 Q2 BU별 매출비중 + 마진 구조](2026-Q1_MU_bu_margin_mix.png)

→ (출처: Micron Q2 FY26 Press Release Quarterly Business Unit Financial Results)
→ 좌측 도넛: CMBU·MCBU 각 32% 동률 1위 / CDBU 24% / AEBU 11%
→ 우측 바: MCBU GPM 79% + OPM 76%으로 전 BU 중 최고 — 모바일/Client 메모리 ASP 폭등 효과
→ AEBU는 매출 비중·마진 모두 가장 낮으나 1년 전 GPM 21%·OPM 6% 대비 +47/+56pp 점프
