...
representative_companies:
  - era: "1872-1994"
    era_name: "우편 카탈로그·TV 홈쇼핑·인프라 형성 (이커머스 precursor)"
    region: "USA"
    companies: ["Sears Roebuck", "Montgomery Ward", "QVC", "HSN", "L.L. Bean", "AOL (인프라)"]
  - era: "1995-2010"
    era_name: "닷컴 1세대·중국 부상 (Amazon·eBay·Alibaba 탄생)"
    region: "USA+China"
    companies: ["Amazon(AMZN)", "eBay(EBAY)", "Alibaba(BABA)", "JD.com(JD)", "Yahoo Shopping", "Best Buy(BBY)", "Walmart(WMT)", "Pets.com (폐업 사례)", "Webvan (폐업)"]
  - era: "2011-2019"
    era_name: "모바일 패권·물류 자체화·플랫폼 빅3 형성"
    region: "USA+China+Korea"
    companies: ["Amazon(AMZN)", "Alibaba(BABA)", "JD.com(JD)", "쿠팡(CPNG)", "Shopify(SHOP)", "Etsy(ETSY)", "MercadoLibre(MELI)", "Walmart(WMT)", "네이버(035420.KS)"]
  - era: "2020-current"
    era_name: "코로나 폭발·크로스보더·라이브커머스·AI·풀필먼트 자동화"
    region: "USA+China+Korea+Latam+SEA"
    companies: ["Amazon(AMZN)", "Alibaba(BABA)", "Pinduoduo(PDD)", "Temu (PDD)", "Shein", "Shopify(SHOP)", "쿠팡(CPNG)", "MercadoLibre(MELI)", "네이버(035420.KS)", "카카오(035720.KS)", "Sea Limited Shopee(SE)", "Douyin (ByteDance)", "Kuaishou(1024.HK)", "JD.com(JD)", "Lazada (Alibaba)"]
---
...
| **반독점** | 미국 FTC·EU·중국 SAMR·한국 KFTC | Amazon·Alibaba·쿠팡 규규제 강화 |
