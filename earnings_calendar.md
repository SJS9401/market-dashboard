...
| (~7/23) | SK하이닉스 | 반도체 | 2Q26 잠정실적 — 과거 패턴 추정 (Q1: 4/23, 매 분기 동일 요일 패턴) |
| (~7/28) | 삼성SDI | 배터리 | 2Q26 확정실적 콘퍼런스콜 — 과거 패턴 추정 (Q1: 4/28) |
| 7/28 | Alphabet (GOOGL) | 빅테크 | Q2 2026, AMC — 다수 소스 7/28 일치 (StockEvents·Nasdaq 확인, 미공식) |
...
| (~7/29) | ARM Holdings (ARM) | 반도체-CPU | Q1 FY2027 — 과거 패턴 추정, 미확정 (wallstreethorizon 추정) |
