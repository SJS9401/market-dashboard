...
| 7/24 | Hitachi Energy (HE) | 전력 | Q1 FY2027 (4~6월분) — 히타치 그룹(6501) 세그먼트 결과 (히타치 7/24 발표 확정 — TipRanks. HVDC 백로그·데이터센터 전력 수요 업데이트) |
| 7/24 | 현대로템 | 방산 | 2Q26 잠정실적 (FnGuide 7/24 확정 — 확정실적 CC ~8/18 별도) |
| (~8/18) | 현대로템 | 방산 | 2Q26 확정실적 — Investing.com·IRGO 확인 (잠정실적 7/24 FnGuide 확정. 기존 ~7/24 → ~8/18 정정) |
| (~7/24) | 삼성중공업 | 조선 | 2Q26 실적 — 과거 패턴 추정 (Q1: 4/24) |
| (~7/25) | 효성중공업 | 전력 | 2Q26 잠정실적 — 과거 패턴 추정 (Q1: 4/24) |
| (~7/25) | LG에너지솔루션 | 배터리 | 2Q26 확정실적 콘퍼런스콜 — 과거 패턴 추정 (2025 Q2: 7/25, 2024 Q2: 7/25. 6/28 갱신: 기존 ~7/30 → ~7/25 정정) |
...
| (~7/27) | LIG넥스원 | 방산 | 2Q26 실적 — 과거 패턴 추정 (Q1: 4/27) |
...
| 7/29 | SK하이닉스 | 반도체 | 2Q26 확정실적 콘퍼런스콜 (확정, 7/3 재확인 — 컨센 영업이익 63~70조, OPM 76%+ 달성·마이크론 80.4% 갱신 여부, HBM4 양산, ADR 업데이트) |
